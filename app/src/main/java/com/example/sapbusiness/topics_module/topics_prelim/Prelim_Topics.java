package com.example.sapbusiness.topics_module.topics_prelim;
...
import com.example.sapbusiness.adapters.TopicsList_Adapter;
...
public class Prelim_Topics extends AppCompatActivity {
    ...
    private void intentToAddEditTopic() {
        Intent intent = new Intent(this, Add_Edit_Topic.class);
        intent.putExtra("activity", "Prelim");
